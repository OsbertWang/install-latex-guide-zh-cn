...
\begin{itemize}
  \item 添加仅限单位内部访问的源
  \item 更新 VS Code 外部调用 SumatraPDF 的设置
\end{itemize}
...
\begin{itemize}
  \item 更新 WSL 的 SumatraPDF 阅读器设置
  \item 更新 Ubuntu 换源配置
  \item 增加磁盘空间确认内容
\end{itemize}
...
\begin{itemize}
  \item 增加了国内镜像网站
  \item 适应 Overleaf 新版界面调整了介绍
\end{itemize}

\section*{v2025.11.1}

\begin{itemize}
  \item 调整 VS Code 的配置说明
  \item 修订 Ubuntu 下 "tlmgr" 使用权限问题
\end{itemize}

\section*{v2025.10.1}

\begin{itemize}
  \item Overleaf 升级为 2025 版
  \item 更新 WSL 镜像挂载
\end{itemize}
