...
例如, \texttt{iso} 镜像文件在主系统中的路径是 \path{C:\Users\username\Downloads\texlive2026.iso},
那么在 WSL 中其路径是 \path{/mnt/c/Users/username/Downloads/texlive2026.iso}.
理解上述路径对应关系后,
进入 \textsf{bash} 并执行如下命令
\begin{lstlisting}
  sudo mkdir -p /mnt/iso
  sudo mount -o loop /mnt/c/Users/username/Downloads/texlive2026.iso /mnt/iso
\end{lstlisting}
...
系统返回类似如下内容
\begin{lstlisting}[language = {}]
  /usr/local/texlive/2026/texmf-dist/scripts/texdoc/texdoclib.tlu 4.1.1
  Configuration file(s):
      active      /usr/local/texlive/2026/texmf-dist/texdoc/texdoc.cnf
...
系统会显示
\begin{lstlisting}[language = {}]
   1 /usr/local/texlive/2026/texmf-dist/doc/latex/lshort-chinese/lshort-zh-cn.pdf
...
然后分别执行
\begin{lstlisting}[language = {}]
  cd /usr/local/texlive/2026/texmf-dist/doc/latex/lshort-chinese/
  explorer.exe .
\end{lstlisting}
主系统的资源管理器便会打开.
