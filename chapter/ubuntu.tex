...
若显示
\begin{lstlisting}
  f5872cb2dec838670f91ed5c62493553  texlive2026.iso
\end{lstlisting}
则镜像文件下载正确.
同样可验证 SHA512 值,
执行
\begin{lstlisting}
  cd ~/Downloads
  sha512sum texlive2026.iso
\end{lstlisting}
正确的返回结果为
\begin{lstlisting}[literate={a}{a}{1} {b}{b}{1} {c}{c}{1} {d}{d}{1} {e}{e}{1} {f}{f}{1}]
  4a9071bb567c3bdd6443378dedc8e485aea4a2f1203ec8ed7c17f6787093b9c37636a037032c0be63352e3d0bf98cf5616dab19fdcd7cb83f766b3e085b620ff  texlive2026.iso
\end{lstlisting}

将下载的光盘镜像进行装载
\begin{lstlisting}
  sudo mkdir /mnt/texlive
  sudo mount ./texlive2026.iso /mnt/texlive
\end{lstlisting}
接下来执行
\begin{lstlisting}
...
\begin{lstlisting}[language = {}, deleteemph = set]
  ...
  = help>   https://tug.org/texlive/doc/install-tl.html   <=======
   ...
   <C> set installation collections:
       40 collections out of 41, disk space required: 9388 MB (free: 974100 MB)
...
这时一定要关注其中的
\begin{lstlisting}[language = {}, deleteemph = set]
  disk space required: 9388 MB (free: 974100 MB)
\end{lstlisting}
它代表了安装所需空间 "9388 MB",
而目前空余空间 "974100 MB".
根据每台电脑的实际情况,
...
\begin{lstlisting}
  # Add TeX Live to the PATH, MANPATH, INFOPATH
  export PATH=~/.local/texlive/2026/bin/x86_64-linux:$PATH
  export MANPATH=~/.local/texlive/2026/texmf-dist/doc/man:$MANPATH
  export INFOPATH=~/.local/texlive/2026/texmf-dist/doc/info:$INFOPATH
\end{lstlisting}
有关字体的处理变为%
\footnote{这里并未使用
...
\begin{lstlisting}
  cp ~/.local/texlive/2026/texmf-var/fonts/conf/texlive-fontconfig.conf $XDG_CONFIG_HOME/fontconfig/conf.d/09-texlive.conf
\end{lstlisting}
然后执行
\begin{lstlisting}
  fc-cache -fv
...
执行
\begin{lstlisting}
  sudo chown -R root:root /usr/local/texlive/2026
...
当然, 用户也可以直接使用
\begin{lstlisting}
  dpkg -l | grep '^ii' | grep -i -E 'texlive|tex live'
\end{lstlisting}
...
默认安装的用户直接运行
\begin{lstlisting}[deletekeywords = local]
  sudo rm -rf /usr/local/texlive/2026
  rm -rf ~/.texlive2026
\end{lstlisting}
