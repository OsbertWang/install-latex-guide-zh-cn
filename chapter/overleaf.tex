...
新建项目后,
用户便可进入编辑界面.
在编辑界面用户需要先在左上角 \menu{File > Settings > Compiler} 中,
选择合适的编译命令和主文件.
由于默认字体和文件编码等原因,
...
用户编写的文件会保存在网站.
编写完成后,
用户只需点击 \menu{File} 左边的图标回到项目列表.
这时可以看到新增项目右侧有五个图标,
它们分别是 \menu{Copy}、\menu{Download .zip file}、\menu{Download PDF}、\menu{Archive} 和 \menu{Trash}.
用户可根据自己的需求点击合适的图标.
...
只需在 \menu{File > Settings > Compiler} 选择版本即可.
...
相较于因网络问题难以注册和使用 Overleaf，
国内的在线 \LaTeX{} 平台则不存在这一障碍。
因此，本手册将对其进行简要介绍，以便用户选择。
...
\href{https://www.texhub.com/}{TeXHub} 是一个专为学术研究者打造的下一代 \LaTeX{} 写作平台,
集团队协作与直观界面于一体.
它整合了学术研究者所需的各类工具,
让用户能够专注于内容创作,
而无需为繁琐的格式调整费心.
...
\subsection{Keepresearch}

\href{https://www.keepresearch.com/}{Keepresearch} 是一个较新的国内平台,
据官网介绍,
该平台的特色是融合了人工智能技术,
例如AI分析、AI演示文稿等.
此外,
该平台还具备较强的文件管理功能,
并提供了若干拓展工具.
目前该平台已经涵盖了 2025 国自然基金模板,
相信能够在一定程度上提升科研工作者的工作效率.

\subsection{FlyLaTeX}

\href{https://flylatex.cn/}{FlyLaTeX} 是最近才出现的国内平台,
有关它的介绍还不多,
官网也并未对其特色进行太详尽的说明.
该网站的%
\href{https://www.flylatex.cn/pdf-viewer.html?pdf=./Files/FlyLaTeX.pdf}{用户手册}%
内容较为丰富,
用户可以参考.
