...
而 \TeX studio 在本地的位置是 \texttt{<TeXstudioDIR>}.
打开 \menu{Options > Configure TeXstudio} 窗口,
在 \menu{Build > User commands} 中添加
\begin{lstlisting}
  "<SumatraPDFDIR>\SumatraPDF.exe" -reuse-instance -forward-search ?c:am.tex @ -inverse-search "<TeXstudioDIR>\texstudio.exe %%f -line %%l" ?am.pdf
\end{lstlisting}
...
\begin{lstlisting}
  "<SumatraPDFDIR>\SumatraPDF.exe" -reuse-instance -forward-search ?c:am.tex @ -inverse-search "<TeXstudioDIR>\texstudio.exe %%f -line %%l" ?a)temp\?m.pdf
\end{lstlisting}
