...
\footnote{主文档和子文档的更多内容请参考 "\include"
和 "\input" 的用法}. 
\begin{lstlisting}[language = {[LaTeX]TeX}]
  % !TeX encoding = UTF8
\end{lstlisting}
...
对自己网络非常自信的用户也可以参考
\href{https://en.wikipedia.org/wiki/Comparison_of_TeX_editors}{\textsc{\fontspec[StylisticSet = 5, Extension = .otf]{LinLibertine_R}W\kern-.05em ikipediA}}
上的对比结果.
