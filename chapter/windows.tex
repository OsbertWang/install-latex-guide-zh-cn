...
则注册表位置将变为
\begin{lstlisting}
  HKEY_LOCAL_MACHINE\SOFTWARE\Classes\TL.bitmap2eps.convert.2020
  HKEY_LOCAL_MACHINE\SOFTWARE\Classes\TL.DVIOUT.view.2020
  HKEY_LOCAL_MACHINE\SOFTWARE\Classes\TL.TeXworks.edit.2020
\end{lstlisting}
