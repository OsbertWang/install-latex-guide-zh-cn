...
Mac\TeX\ 的镜像路径需将 \TeX~Live 路径中的 \path{.../texlive} 替换为 \path{.../mac/mactex}.
例如, 阿里云的镜像地址为 \url{https://mirrors.aliyun.com/CTAN/systems/mac/mactex/},
北京大学的镜像地址为 \url{https://mirror.pku.edu.cn/ctan/systems/mac/mactex/}.
其他镜像也类似,
不再一一列举.
