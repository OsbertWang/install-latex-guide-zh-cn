...
\begin{lstlisting}
  ...
  Codename:       jammy
\end{lstlisting}
然后在 \textsf{PowerShell} 中执行
\begin{lstlisting}
  ni -ItemType Directory -Path "X:\WSL\instances\Ubuntu2204" -Force
  sl (ni -ItemType Directory -Path "X:\WSL\images" -Force)
\end{lstlisting}
创建新的位置.
