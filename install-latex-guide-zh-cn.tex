...
\include{windows}
\InputIfFileExists {windows}
  {}{\include{chapter/windows}}
\include{ubuntu}
\InputIfFileExists {ubuntu}
  {}{\include{chapter/ubuntu}}
\include{macos}
\InputIfFileExists {macos}
  {}{\include{chapter/macos}}
\include{wsl}
\InputIfFileExists {wsl}
  {}{\include{chapter/wsl}}
\include{editor}
\InputIfFileExists {editor}
  {}{\include{chapter/editor}}
\include{overleaf}
\InputIfFileExists {overleaf}
  {}{\include{chapter/overleaf}}

\appendix
\include{mirror}
\InputIfFileExists {mirror}
  {}{\include{chapter/mirror}}
\include{addition}
\InputIfFileExists {addition}
  {}{\include{chapter/addition}}
\include{offline}
\InputIfFileExists {offline}
  {}{\include{chapter/offline}}
\include{updateinfo}
\InputIfFileExists {updateinfo}
