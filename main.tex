...
\section{安装 \TeX{} Live}
首先用户下载 \TeX{} Live 的 \href{http://mirrors.ctan.org/systems/texlive/Images/texlive.iso}{镜像文件（iso文件）}。
...
其他编辑器如 \href{https://github.com/EthanDeng/vscode-latex}{VScode} 和 \href{https://ddswhu.me/posts/2018-06/sublime-text-for-latex/}{Sublime Text}，感兴趣的用户可自行了解它们的使用方法。
另外还有很多用户喜欢使用 Vim 或 Emacs 等强大的编辑器，因作者能力有限，无法一一列举，还请自己在网上寻求更多帮助。
