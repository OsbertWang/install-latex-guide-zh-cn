...
\subsubsection{调整缩进}
在 \texttt{Options -> Editor -> Indentation Mode} 处可以选择是否保持缩进，旁边的 \texttt{Replace Indentation Tab by Spaces} 勾选后可以让缩进完全变为空格。
