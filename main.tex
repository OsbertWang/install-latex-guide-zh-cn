...
\title{\bfseries 一份简短的关于 \LaTeX{} 安装的介绍\thanks{\url{https://github.com/OsbertWang/install-latex}}}
\author{啸行\thanks{\href{mailto:ranwang.osbert@outlook.com}{\ttfamily ranwang.osbert@outlook.com}}}
\date{\today}
...
\appendix
\include{./chapter/moreonwsl}
\include{./chapter/installoffline}
