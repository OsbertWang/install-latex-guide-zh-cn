...
\lstset{
  ...
  emph            = {mkdir,tlmgr,pdflatex,latexmk,documentclass,begin,LaTeX},
}
...
%\chapter{WSL 下安装}
%在 windows 系统下, 我自己硬盘中有两个分区, 分别是 \lstinline|C:\| 和 \lstinline|D:\|.
%挂载 texlive2019.iso 到 \lstinline|F:\|.
%接下来执行 \lstinline|bash| 打开 wsl, 执行 \lstinline|ls /mnt| 会看到
%\begin{lstlisting}[frame=single]
%c  d
%\end{lstlisting}
%也就是说在主系统下挂载的镜像文件并没有被 wsl 认可.
%这种情况下需要自己先建一个文件夹:
%\begin{lstlisting}[frame=single]
%sudo mkdir /mnt/f
%\end{lstlisting}
